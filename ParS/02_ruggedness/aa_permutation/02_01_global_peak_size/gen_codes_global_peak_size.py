...
#####################
# parameters
randType = sys.argv[1]	# randomization type: "aa_permutation" or "random"
...
for seed in range(100000):
	...
	# compute the size of the global peak (RCWS)
	vals = list(code.values())
	global_size = vals.count("R") * vals.count("C") * vals.count("W")* vals.count("S")
