---
title: "ParE3, landscape ruggedness, aa permutation codes"
...
```{r}
tmp_res = results[results$SummitSize==results$SummitSize[results$Seed==0] & !results$SplitAa %in% c("E", "D", "W"),]
nrow(tmp_res)
