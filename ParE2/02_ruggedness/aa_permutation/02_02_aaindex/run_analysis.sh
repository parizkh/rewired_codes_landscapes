...
sbatch -t 1-00 --wrap="python3 ../../../../code/correlations_aaindex.py input/results_sorted.tsv output/results_aaindex 4 E,L,K"
sbatch -t 1-00 --wrap="python3 ../../../../code/correlations_null_aaindex.py input/results_sorted.tsv output/results_aaindex_null 4 E,L,K"
