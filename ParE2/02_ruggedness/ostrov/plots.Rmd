---
title: "ParE2, Ostrov codes, landscape ruggedness"
...
ggplot(data, aes(x=Robustness, y=Correlation, color=NumSplit, shape=pval_cat)) +
  geom_point() + theme_test() +
  labs(y="Correlation between number of stop codons\nand number of peaks", x="Code robustness", main="ParE2") +
...
ggplot(data, aes(x=Robustness, y=Correlation, color=NumSplit, shape=pval_cat)) +
  geom_point() + theme_test() +
  labs(y="Correlation between number of stop codons\nand mutational accessibility of the summit", x="Code robustness", main="ParE2") +
  scale_color_viridis_d() + geom_hline(yintercept=0, linetype="dashed") +
  scale_shape_discrete(name="P-value")
```
...
data = data[!is.na(data$Correlation),]
 ggplot(data, aes(x=Robustness, y=Correlation, color=NumSplit, shape=pval_cat)) +
  geom_point() + theme_test() +
  labs(y="Correlation between number of stop codons\nand prevalence of no epistasis", x="Code robustness", main="ParE2") +
  scale_color_viridis_d() + geom_hline(yintercept=0, linetype="dashed") +
  scale_shape_discrete(name="P-value")
```
...
ggplot(data, aes(x=Robustness, y=Correlation, color=NumSplit, shape=pval_cat)) +
  geom_point() + theme_test() +
  labs(y="Correlation between number of stop codons\nand prevalence of magnitude epistasis", x="Code robustness", main="ParE2") +
  scale_color_viridis_d() + geom_hline(yintercept=0, linetype="dashed") +
  scale_shape_discrete(name="P-value")
```
...
ggplot(data, aes(x=Robustness, y=Correlation, color=NumSplit, shape=pval_cat)) +
  geom_point() + theme_test() +
  labs(y="Correlation between number of stop codons\nand prevalence of simple-sign epistasis", x="Code robustness", main="ParE2") +
  scale_color_viridis_d() + geom_hline(yintercept=0, linetype="dashed") +
  scale_shape_discrete(name="P-value")
```
...
ggplot(data, aes(x=Robustness, y=Correlation, color=NumSplit, shape=pval_cat)) +
  geom_point() + theme_test() +
  labs(y="Correlation between number of stop codons\nand prevalence of reciprocal-sign epistasis", x="Code robustness", main="ParE2") +
  scale_color_viridis_d() + geom_hline(yintercept=0, linetype="dashed") +
  scale_shape_discrete(name="P-value")
```
