---
title: "GB1: Correlation of landscape properties with aaindex"
...
# Save the data
```{r}
write.table(results[,c(1,2,22,23,3,24,25,4,26,27,5,28,29,6,30,31,7)], file="output/supp_data_S1.csv", quote=FALSE, sep=",", row.names=FALSE)
```
